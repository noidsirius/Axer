...
import static dev.navids.latte.TalkBackUtils.DiagnosticOverlayUtils.FOCUS_FAIL_FAIL_ALL_FOCUS_TESTS;
import static dev.navids.latte.TalkBackUtils.DiagnosticOverlayUtils.FOCUS_FAIL_NOT_SPEAKABLE;
import static dev.navids.latte.TalkBackUtils.DiagnosticOverlayUtils.FOCUS_FAIL_NOT_VISIBLE;
import static dev.navids.latte.TalkBackUtils.DiagnosticOverlayUtils.FOCUS_FAIL_SAME_WINDOW_BOUNDS_CHILDREN;
import static dev.navids.latte.TalkBackUtils.DiagnosticOverlayUtils.NONE;
...
//import com.google.android.accessibility.utils.AutoValue_AccessibilityNodeInfoUtils_ClickableString;
//import com.google.android.accessibility.utils.AutoValue_AccessibilityNodeInfoUtils_ViewResourceName;
...
import dev.navids.latte.TalkBackUtils.DiagnosticOverlayUtils.DiagnosticType;
//import com.google.android.accessibility.utils.FeatureSupport;
//import com.google.android.accessibility.utils.Filter;
//import com.google.android.accessibility.utils.PrimitiveUtils;
//import com.google.android.accessibility.utils.Role;
import dev.navids.latte.TalkBackUtils.Role.RoleName;
...
//            || hasValidRangeInfo(node));
  ...
  public static boolean isTopLevelScrollItem(AccessibilityNodeInfoCompat node) {
    ...
    try {
      ...
      @RoleName int parentRole = Role.getRole(parent);
...
//   * AccessibilityNodeInfoUtils.getText()} returns hint text. Hence this method checks for {@link
  ...
  public abstract static class ViewResourceName {
    ...
    public static  ViewResourceName create(AccessibilityNodeInfoCompat node) {
      ...
      // TODO: Navid changed this
      return new ViewResourceName() {
          @Override
