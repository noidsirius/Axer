...
//import com.google.android.libraries.accessibility.utils.url.AutoValue_SpannableUrl;
//import com.google.android.libraries.accessibility.utils.url.UrlUtils;
...
//    return new AutoValue_SpannableUrl(urlSpan, string);
   ...
   * example, if a spannable string "Click here" has a {@link URLSpan} on the
   * text "here," the text value would be "here." It is possible for this to be the same value as
   * the URL path.
   */
  public abstract String text();

  /** A URL path from a {@link URLSpan}. */
  public String path() {
